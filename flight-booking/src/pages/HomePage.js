          ...
          <li key={flight.id} style={{ borderBottom: '1px solid #ddd', marginBottom: '10px', paddingBottom: '10px' }}>
            ...
            {expandedFlightId === flight.id && (
              <div style={{ marginTop: '10px' }}>
                <p><strong>Departure:</strong> {formatDate(flight.departureDate)} at {flight.departureTime}</p>
                <p><strong>Arrival:</strong> {formatDate(flight.arrivalDate)} at {flight.arrivalTime}</p>
